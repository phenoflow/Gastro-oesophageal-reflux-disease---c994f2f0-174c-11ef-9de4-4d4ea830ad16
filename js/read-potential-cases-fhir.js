...
(async () => {
  ...
  await fs.writeFile("gastro-oesophageal-reflux-disease-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("gastro-oesophageal-reflux-disease-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
